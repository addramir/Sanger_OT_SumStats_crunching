...
gwas_list_exists=!gsutil ls gs://genetics-portal-dev-sumstats/tmp/yt4-filtered-sumstats/
gwas_list_exists=gwas_list_exists[1:]

gwl1=[i.replace('gs://genetics-portal-dev-sumstats/unfiltered/gwas/','') for i in gwas_list]
gwl1=[i.replace('.parquet/','') for i in gwl1]

gwl2=[i.replace('gs://genetics-portal-dev-sumstats/tmp/yt4-filtered-sumstats/','') for i in gwas_list_exists]
